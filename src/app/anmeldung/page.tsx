...
export default function EventsPage() {
  return (
    <PageLayout>
      ...
      <p>
        Die Anmeldung und Organisation des PMP findet im Vatsim Germany <a href="https://board.vatsim-germany.org/forums/piloten-mentoren-programm.739/">Forum Piloten-Mentoren-Programm</a> statt. Bevor du eine Anmeldung schreibst, lies dir bitte <a href="https://board.vatsim-germany.org/threads/pmp-training-dein-weg-zum-online-piloten.74740/">diesen Beitrag</a> durch. Zusätzlich haben wir das Wesentliche für dich hier zusammengefasst.
      </p>
      ...
      <div className="card">
        ...
        <ol>
          ...
          <li>
            ...
            <p>Bist du auch auf dem offiziellen Vatsim Germany Discord registriert?</p>
          </li>
          <li>
  ...
  <h3 style={{ textAlign: 'center' }}><a href="https://board.vatsim-germany.org/threads/pmp-training-dein-weg-zum-online-piloten.74740/" target="_blank" className="card card-link">Zur Anmeldung</a></h3>
      </div>
    </PageLayout>
  );
}
